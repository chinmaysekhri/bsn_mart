...
/*	  if($is_admin == 'super_admin'){
        ...
        $buyerSellerData   = User::where('for','=','seller')
         ...
         $buyerSellerData  = User::where('for','=','buyer')
			...
			//20-01-2025  employee code only variable error ke liye h Withdrawal only Buyer & seller ke liye h	.
    ...
    public function store(Request $request): RedirectResponse
    {
		...
		$withdrwal_amt     = intval($input['withdrawal_amount']);  //23-11-2024
		
		//$withdrwal_req_amt = $input['withdrawal_amount'];;  //26-12-2024
		...
		//Check widthrawal requested amount 26-12-2024 start
		...
		//Check widthrawal requested amount 26-12-2024 end		
		//25-11-2024
	    ...
	    $input['withdrawal_request_amount']  = $request->withdrawal_amount;	
