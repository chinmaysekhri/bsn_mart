...
<div class="grid grid-cols-1 gap-6 pt-5 lg:grid-cols-1">
   <div class="panel">
      <div class="mb-5">
         ...
         @endif
         {!! Form::open(array('route' => 'subcategories.store','method'=>'POST','class'=>'space-y-5', 'enctype'=>'multipart/form-data')) !!}
         <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
             ...
             <div>
               <label for="sub_category_name"><i class="fa fa-asterisk" style="font-size:6px;color:red"></i>Sub Category Name</label>
