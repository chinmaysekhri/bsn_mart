...
<html lang="en" dir="ltr">
    <head>
        ...
        <title>Traders Mart's Reset Your Password</title>
    ...
    >
		...
		<!-- Flash  Message  End  -->
                   <!-- <h2 class="mb-3 text-2xl font-bold">Sign In</h2>-->
                    <p class="mb-7">Enter your new password to login</p>
                    <form class="space-y-5" method="post" action="{{route('reset.password.post')}}">
                         @csrf
                         <input type="hidden" name="remember_token" value="{{ $remember_token }}">
                         
                        <!--<div>
                            <label for="email_address">E-Mail</label>
                            <input type="text" id="email_address" class="form-input" name="email" required autofocus>
                        </div>-->
                        
                          <div>
                            <label for="password">New Password</label>
                             <input type="password" id="password" class="form-input" name="password" required autofocus>
                        </div>
						
                        <div>
                            <label for="password">Confirm Password</label>
                              <input type="password" id="password-confirm" class="form-input" name="password_confirmation" required autofocus>
                        </div>
