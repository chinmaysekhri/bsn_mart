...
<div x-data="form">
   <ul class="flex space-x-2 rtl:space-x-reverse">
      <li>
         <a href="{{route('purchasereturns.index')}}" class="text-primary hover:underline">Purchase Returns</a>
      </li>
      <li class="before:content-['/'] ltr:before:mr-1 rtl:before:ml-1">
         <span>Create Purchase Returns</span>
      </li>
   </ul>
</div>
            ...
            <div class="panel">
               <!-- browser default -->
                ...
                <!--  <form class="space-y-5" @submit.prevent="submitForm5()">-->
				  ...
				  <form class="space-y-5" action="{{route('purchasereturns.store')}}" method="Post">
				  @csrf
                     <div class="grid grid-cols-1 md:grid-cols-4 gap-5 mb-5">
                        ...
                        <div class="">
                           ...
                           <select class="form-select text-white-dark" id="seller_id" name="seller_id[]" onchange="sellerProductData(this);" required="required" />
                              ...
                              <option value="{{$seller->id}}">{{ucwords($seller->first_name.' '.$seller->last_name)}}</option>
							  @endforeach
