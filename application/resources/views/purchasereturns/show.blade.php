...
@section('title','Show Purchase Return')   
@section('content')
<div x-data="form">
         ...
         <div class="mb-5">
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
			    ...
			    @php 
                 ...
                 if(!empty($purchasereturn->created_by)){
					 
                 $getCreatedByName = Helper::getAssignUserNameData($purchasereturn->created_by);
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
               ...
               $getSellerData = json_decode($purchasereturn->seller_id,true);
			...
			<div>
              <label for="Quantity"></label>
                <strong>Product Name :</strong>
                     ...
                     $getProductName = (json_decode($purchasereturn->product_id,true));
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
               <div>
                 ...
                 {{ucwords($purchasereturn->warehouse_name)}}
                  </label>
               </div>
              ...
              <strong>Quantity:</strong>
               @php
                ...
                $getQuantity = json_decode($purchasereturn->product_quantity,true);
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
               ...
               <div>
				  ...
				  @php
                     ...
                     $getRate = (json_decode($purchasereturn->product_price,true));
               ...
               <div>
                  ...
                  <strong>Total Amount : </strong>
                    {{round($purchasereturn->purchase_final_total)}}
                  </label>
               </div>
            </div>
         </div>
