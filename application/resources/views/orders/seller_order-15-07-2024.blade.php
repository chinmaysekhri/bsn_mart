               ...
               <tbody>
                  @php 
                   ...
                   <tr>
                                ...
                                <td><button onclick="total_delivered()">0</button></td>
                                <td>0</td>
                                <td><button onclick="returned_orders()">0</button></td>
                                <td>0</td>
                    ...
                    <table id="myTable1" class="whitespace-nowrap dataTable-table">
                        ...
                        <tbody>
                            <tr>
                                <td>1</td>
                                <td>28/11/23</td>
                                <td>25(total no of delivered in a date)</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
...
var url = "{{ route('get_today_single_product_order') }}";
 ...
 console.log(result);
      ...
      $.each(result.orderDateCount, function(key, value) {
        
      $('#dateWiseOrder').append('<tr><td>'+sn+'</td><td>'+key+'</td><td>'+value+'</td></tr>');
