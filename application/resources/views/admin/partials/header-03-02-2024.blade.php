					...
					<div class="shadow-sm">
                        <div class="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-[#0e1726]">
                            <div class="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                                <a href="{{route('dashboard')}}" class="main-logo flex shrink-0 items-center">
                                    <img class="inline w-8 ltr:-ml-1 rtl:-mr-1" src="{{ asset('admin/assets/images/logo.png') }}" alt="image" style="width: 158px" />
                            ...
                            >
                                ...
                                <div class="dropdown flex-shrink-0" x-data="dropdown" @click.outside="open = false">
                                    ...
                                    >
                                        ...
                                        @if(empty($profile_data['auth_user']->for == 'super_admin'))
										
                                        <li>
                                            <a href="{{ $profile_route }}" class="dark:hover:text-white" @click="toggle">
                                                <svg
                        ...
                        >
                            <li class="menu nav-item relative">
                                ...
                                <ul class="sub-menu">
                                    <li>
                                        <a href="http://finley.asia/" class="active">Visit Website</a>
                                    </li>
                                   <!-- <li>
                                        <a href="#">Analytics</a>
                                    </li>
                            ...
                            <li class="menu nav-item relative">
                                ...
                                <ul class="sub-menu">
                                    <li>
                                        <a href="{{route('view_profile')}}">Manage Profile</a>
                                    </li>
                            ...
                            <li class="menu nav-item relative">
                                <a href="javascript:;" class="nav-link">
                                    <div class="flex items-center">
                                        ...
                                        <span class="px-1">Pros Management</span>
                                    </div>
                                    <div class="right_arrow">
                                        <svg
                                            class="h-4 w-4 rotate-90"
                     ...
                     <li class="menu nav-item relative">
                                ...
                                <a href="javascript:;" class="nav-link">
                                    <div class="flex items-center">
                                        ...
                                        <span class="px-1">Product Management</span>
                                    </div>
                                    <div class="right_arrow">
                                        <svg
                                            class="h-4 w-4 rotate-90"
                            ...
                            <li class="menu nav-item">
                                ...
                                <a href="javascript:;" class="nav-link">
                                    <div class="flex items-center">
                                        ...
                                        <span class="px-1">Order Management</span>
                                    </div>
                                    <div class="right_arrow">
                                        <svg
                                            class="h-4 w-4 rotate-90"
                                ...
                                <a href="#" class="nav-link group">
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Manage Buyer Order</span>
                                    </div>
                                </a>
                            </li>
