...
elseif($profile_data['auth_user']->for == 'company')
{
...
elseif($profile_data['auth_user']->for == 'seller')
{
...
elseif($profile_data['auth_user']->for == 'buyer')
{
...
elseif($profile_data['auth_user']->for == 'employee')
{
...
elseif($profile_data['auth_user']->for =='customer')
{
$profile_route = route('customer_profile');
if(!empty($profile_data['profile']->profile_img)){
$profile_img = asset('public/uploads/users/profile/'.$profile_data['auth_user']->profile_img);
}elseif(empty($profile_data['profile']->profile_img) && empty($profile_data['profile']->gender) ){
$profile_img = asset('public/uploads/users/profile/profile.png');
...
<div class="shadow-sm">
   <div class="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-[#0e1726]">
      <div class="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
         ...
         <img class="inline w-8 ltr:-ml-1 rtl:-mr-1" src="{{ asset('admin/assets/images/bsn_logo.png') }}" alt="image" style="width: 183px" />
         <span
      ...
      <div
         ...
         <div class="dropdown shrink-0" x-data="dropdown" @click.outside="open = false">
            <a
               ...
               @click="toggle"
               >
            <img src="{{asset('public/admin/assets/images/flags/india_flag.jpg')}}" class="h-5 w-5 rounded-full object-cover">
            </a>
            <ul
               x-cloak
               x-show="open"
               ...
               <template x-for="item in languages">
                  <li>
                     ...
                     <img
                        ...
                        :src="`admin/assets/images/flags/${item.value.toUpperCase()}.svg`"
                        alt="image"
                        />
                        ...
                        <div class="grid place-content-center rounded">
                           <div class="relative h-12 w-12">
                              <img
                                 ...
                                 :src="`admin/assets/images/${notification.profile}`"
                                 alt="image"
                                 />
            ...
            <ul
               ...
               <li>
                  <div class="flex items-center px-4 py-4">
                     <div class="flex-none">
                        <img class="h-10 w-10 rounded-md object-cover" src="{{ $profile_img }}" alt="image" />
                     </div>
               ...
               <li>
                  <a href="{{route('view_profile')}}" class="dark:hover:text-white" @click="toggle">
                     <svg
                  ...
                  @endif
                   ...
                   <li>
                  <a href="{{route('company_profile')}}" class="dark:hover:text-white" @click="toggle">
                     <svg
                        class="h-4.5 w-4.5 shrink-0 ltr:mr-2 rtl:ml-2"
                        width="18"
                        height="18"
                 ...
                 @endif
                  @if(Auth::user()->for == 'employee')
                    <li>
                  <a href="{{route('employee_profile')}}" class="dark:hover:text-white" @click="toggle">
                     <svg
                        class="h-4.5 w-4.5 shrink-0 ltr:mr-2 rtl:ml-2"
                        width="18"
                        height="18"
                ...
                @endif
                 ...
                 @if(Auth::user()->for == 'customer')
                    <li>
                  <a href="{{route('customer_profile')}}" class="dark:hover:text-white" @click="toggle">
                     <svg
                        class="h-4.5 w-4.5 shrink-0 ltr:mr-2 rtl:ml-2"
                        width="18"
                        height="18"
                ...
                @endif
                 ...
                 @if(Auth::user()->for == 'seller')
                    <li>
                  <a href="{{route('seller_profile')}}" class="dark:hover:text-white" @click="toggle">
                     <svg
                        class="h-4.5 w-4.5 shrink-0 ltr:mr-2 rtl:ml-2"
                        width="18"
                        height="18"
                ...
                @endif
                 ...
                 @if(Auth::user()->for == 'buyer')
                    <li>
                  <a href="{{route('buyer_profile')}}" class="dark:hover:text-white" @click="toggle">
                     <svg
                        class="h-4.5 w-4.5 shrink-0 ltr:mr-2 rtl:ml-2"
                        width="18"
                        height="18"
                ...
                @endif
                   @can('wallet-list')
               <li>
                  <a href="{{route('wallets.index')}}" class="dark:hover:text-white" @click="toggle">
                     <svg
                        class="h-4.5 w-4.5 shrink-0 ltr:mr-2 rtl:ml-2"
                        width="18"
                        height="18"
                ...
                @endif
               <li>
                  <a href="{{route('change_password')}}" class="dark:hover:text-white" @click="toggle">
                     <svg
                        class="h-4.5 w-4.5 shrink-0 ltr:mr-2 rtl:ml-2"
                        width="18"
                        height="18"
               ...
               <li class="border-t border-white-light dark:border-white-light/10">
                  <a href="{{ route('logout') }}"  onclick="event.preventDefault();  document.getElementById('logout-form').submit();" class="!py-3 text-danger" @click="toggle">
                     <svg
   ...
   <ul
      ...
      <li class="menu nav-item relative">
         ...
         <ul class="sub-menu">
              @if(Auth::user()->for == 'normal_user' || empty(Auth::user()->for))
            <li>
               <a href="{{route('view_profile')}}">My Details</a>
            </li>
               @endif
                 @if(Auth::user()->for == 'company')
                 <li>
               <a href="{{route('company_profile')}}">My Details</a>
            </li>
              @endif
                  @if(Auth::user()->for == 'employee')
              <li>
               <a href="{{route('employee_profile')}}">My Details</a>
            </li>
             @endif

                  @if(Auth::user()->for == 'customer')
              <li>
               <a href="{{route('customer_profile')}}">My Details</a>
            </li>
              @endif
                  @if(Auth::user()->for == 'seller')
             <li>
               <a href="{{route('seller_profile')}}">My Details</a>
            </li>
              @endif
                  @if(Auth::user()->for == 'buyer')
             <li>
               <a href="{{route('buyer_profile')}}">My Details</a>
            </li>
            @endif
            <li>
               <a href="https://jbn.com/" class="active">Visit Website</a>
            </li>
      ...
      <li class="menu nav-item relative">
         ...
         <ul class="sub-menu">
            ...
            <li>
               <a href="{{route('subcategories.index')}}">Manage Sub-Category</a>
            </li>
              @endcan 
         </ul>
      </li>
      ...
      <li class="menu nav-item relative">
         <a href="javascript:;" class="nav-link">
            <div class="flex items-center">
               ...
               <span class="px-1">User Management</span>
            </div>
            <div class="right_arrow">
               <svg
                  class="h-4 w-4 rotate-90"
         ...
         <ul class="sub-menu">
            ...
            <li>
               <a href="{{route('sellers.index')}}">Manage Seller</a>
            </li>
             @endcan
            @can('buyer-list')
            <li>
               <a href="{{route('buyers.index')}}">Manage Buyer</a>
            </li>
             @endcan
         </ul>
      </li>
      ...
      <!--   <li class="menu nav-item relative">
         <a href="javascript:;" class="nav-link">
             <div class="flex items-center">
                 ...
                 <span class="px-1">Task Management</span>
             </div>
             <div class="right_arrow">
                 <svg
                     class="h-4 w-4 rotate-90"
         ...
         <ul class="sub-menu">
               @can('task-list')
             <li>
                 <a href="{{route('tasks.index')}}">Manage Task</a>
             </li>
                  @endcan 
      ...
      <li class="menu nav-item relative">
         ...
         <ul class="sub-menu">
            ...
            <li>
               <a href="{{route('prospectivesellers.index')}}">Prospective Seller</a>
            </li>
              @endcan 
            @can('sellerapplication-list')
            <li>
               <a href="{{route('sellerapplications.index')}}">Seller Application</a>
            </li>
             @endcan 
         </ul>
      </li>
       ...
       <li class="menu nav-item relative">
         ...
         <ul class="sub-menu">
            ...
            <li>
               <a href="{{route('prospectivebuyers.index')}}">Prospective Buyer</a>
            </li>
              @endcan 
            @can('buyerapplication-list')
            <li>
               <a href="{{route('buyerapplications.index')}}">Buyer Application</a>
            </li>
             @endcan 
         </ul>
      </li>
      ...
      <li class="menu nav-item relative">
         <a href="javascript:;" class="nav-link">
            <div class="flex items-center">
               ...
               <span class="px-1">Orders & Products</span>
            </div>
            <div class="right_arrow">
               <svg
                  class="h-4 w-4 rotate-90"
         ...
         <ul class="sub-menu">
            ...
            <li class="relative">
               ...
               <ul
                  ...
                  >
                   @can('product-list')
                  <li>
                     <a href="{{route('product_list')}}">Search Product</a>
                  </li>
                    @endcan
              @can('product-list')
                  <li>
                     <a href="{{route('cart')}}">Manage Cart</a>
                  </li>
                               @endcan
              @can('order-list')
               <li>
                     <a href="{{route('orders.index')}}">Manage Order</a>
                  </li>
                   @endcan 
             @can('order-list')
              <li>
                     <a href="{{route('my_product_order')}}">My Product(B/S)</a>
                  </li>
                    @endcan 
            ...
            <li class="relative">
             ...
             @can('seller-order-list')
                  <li>
                     <a href="{{route('seller_order')}}">Manage Seller Order</a>
                  </li>
                   @endcan 
            ...
            <li class="relative">
               ...
               <ul
                  ...
                  <li>
                     <a href="{{route('transportaddresses.index')}}">Buyer Shipping Address</a>
                  </li>
                  @endcan 
            @can('sellertransportaddresse-list')
                  <li>
                     <a href="{{route('sellertransportaddresses.index')}}">Seller Shipping Address</a>
                  </li>
                   @endcan
          ...
          <!--   <li class="relative">
            ...
            @can('fund-list')
                  <li>
                     <a href="{{route('funds.index')}}">Manage Funds</a>
                  </li>
                    @endcan 
            @can('withdraw-list')
                  <li>
                     <a href="{{route('withdraws.index')}}">Manage Withdrawal</a>
                  </li>
                   @endcan 
            ...
            <!-- <li class="relative">
               ...
               <ul
                  ...
                  >
                 {{-- <li>
                     <a href="{{route('purchases.index')}}" target="_blank">Add Purchase</a>
                  </li>--}}
                   <li>
            ...
            <li class="relative">
               ...
               <ul
                  ...
                  >
                  {{--<li>
                     <a href="{{route('returncarts.index')}}" target="_blank">Return Cart</a>
                  </li>
                  <li>
                     <a href="{{route('orderreturns.index')}}" target="_blank">Manage Return</a>
                  </li>--}}
               </ul>
            </li> -->
   <!-- <li class="relative">
      ...
      <!--  <li class="menu nav-item relative">
         <a href="javascript:;" class="nav-link">
             <div class="flex items-center">
                 ...
                 <span class="px-1">Category Management</span>
             </div>
             <div class="right_arrow">
                 <svg
                     class="h-4 w-4 rotate-90"
