               ...
               <tbody>
				 ...
				 @endphp
                  <tr>
                     ...
                     <td>{{$withdra->withdrawal_request_amount}}</td>
                     <td>{{$withdra->account_paid_amount}}</td>
                        ...
                        <div class="dark:text-white-dark/70 text-base font-medium text-[#1f2937]">
                           ...
                           <div class="grid grid-cols-1 gap-4 sm:grid-cols-2" id="paidContent" style="display:none">
                              <div>
                                 ...
                                 {!! Form::date('withdrawal_date', null, array('placeholder' => 'Date','class' => 'form-input','id'=>'withdrawal_date')) !!}
                              </div>
                              <div>
                                 <label for="account_paid_amount">Amount</label>
                                 {!! Form::text('account_paid_amount', null, array('placeholder' => 'Enter Amount','class' => 'form-input','id'=>'account_paid_amount')) !!}
                              </div>
                              <div>
                                 <label for="withdrawal_receipt_no">Receipt No.</label>
                                 {!! Form::text('withdrawal_receipt_no', null, array('placeholder' => 'Enter Receipt No','class' => 'form-input','id'=>'withdrawal_receipt_no')) !!}
                              </div>
                              <div>
                                 <label for="upload_withdrawal_receipt">Upload Withdrawal Receipt</label>
                                 {!! Form::file('upload_withdrawal_receipt', null, array('placeholder' => 'Upload Withdrawal Receipt','class' => 'form-input','id'=>'upload_withdrawal_receipt')) !!}
                              </div>
                           </div>
                           <div>
