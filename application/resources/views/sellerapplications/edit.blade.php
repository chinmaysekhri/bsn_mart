...
<div x-data="form">
    <ul class="flex space-x-2 rtl:space-x-reverse">
        <li>
            <a href="{{route('sellerapplications.index')}}" class="text-primary hover:underline">Seller Application</a>
        </li>
        <li class="before:content-['/'] ltr:before:mr-1 rtl:before:ml-1">
            <span>Edit Seller Application</span>
        </li>
    </ul>
...
<div class="grid grid-cols-1 gap-6 pt-5 lg:grid-cols-1">
   <div class="panel">
      <div class="mb-5">
         ...
         @endif
         {!! Form::model($sellerapplication, ['method' => 'PATCH','route' => ['sellerapplications.update', $sellerapplication->id],'class'=>'space-y-5', 'enctype'=>'multipart/form-data']) !!}
         <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div>
               ...
               {!! Form::select('state',[$sellerapplication->state=>$sellerapplication->state],[], array('class' => 'form-select text-white-dark','id'=>'state')) !!}
            </div>
            <div>
               <label for="city">City</label>
               {!! Form::select('city', [$sellerapplication->city=>$sellerapplication->city],[], array('class' => 'form-select text-white-dark','id'=>'city')) !!}
            </div>
             <div>
               <label for="district ">District </label>
                {!! Form::select('district', [$sellerapplication->district=>$sellerapplication->district],[], array('class' => 'form-select text-white-dark','id'=>'district')) !!}
            </div>
         </div>
