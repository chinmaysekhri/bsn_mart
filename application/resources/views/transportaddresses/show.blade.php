...
@section('title','Transport Address Detail')
@section('content')
<div x-data="form">
      ...
      <div class="panel">
         ...
         <div class="mb-5">
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
               ...
               {{($transp_address->FirstName.' '.$transp_address->LastName)}}
                  </label>
               </div>
               <div>
                  <label for="private_marka">
                  <strong>Private Marka:</strong>
                   {{ $transport_address->private_marka }}
                  </label>
               </div>
                <div>
                  <label for="transport_name">
                  <strong>Transport Name:</strong>
                 {{ $transport_address->transport_name }}
                  </label>
               </div>
               <div>
               ...
               <div>
                 ...
                 {{ $transport_address->transport_contact_number }}
                  </label>
               </div>
                  <div>
                  <label for="  delivery_place">
                  <strong>Delivery Place:</strong>
                 {{ $transport_address->  delivery_place }}
                  </label>
               </div>
               ...
               <div>
                ...
                <div>
                    @if(!empty($transport_address->lr_copy_upload))
                     <a href="{{asset('public/uploads/transport_address/lr_copy_upload/'.$transport_address->lr_copy_upload)}}" download="{{$transport_address->lr_copy_upload}}">
