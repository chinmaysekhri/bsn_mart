...
@section('title','Add Buyer Application')
@section('content')
<div x-data="form">
   <ul class="flex space-x-2 rtl:space-x-reverse">
      <li>
         <a href="{{route('buyerapplications.index')}}" class="text-primary hover:underline">Application Buyer</a>
      </li>
...
<div class="grid grid-cols-1 gap-6 pt-5 lg:grid-cols-1">
   <div class="panel">
      <div class="mb-5">
         ...
         @endif
         {!! Form::open(array('route' => 'buyerapplications.store','method'=>'POST','class'=>'space-y-5', 'enctype'=>'multipart/form-data')) !!}
