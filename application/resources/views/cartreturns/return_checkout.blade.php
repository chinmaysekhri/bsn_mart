...
@section('title','Product Return Checkout')
@section('content')
<div x-data="form">
   <ul class="flex space-x-2 rtl:space-x-reverse">
      <li>
         <a href="{{route('my_product_order')}}" class="text-primary hover:underline">Return Cart My Product</a>
      </li>
      <li class="before:content-['/'] ltr:before:mr-1 rtl:before:ml-1">
         <span>Product Return Checkout</span>
      </li>
   </ul>
</div>
...
<form action="{{route('return_buynow')}}" method="POST">
@csrf
<div class="panel">
   <h5 class="mb-5 text-lg font-semibold dark:text-white-light md:absolute md:top-[25px] md:mb-0" style=" margin-left: 470px;">Return Checkout </h5>
   <br>
   <br>
