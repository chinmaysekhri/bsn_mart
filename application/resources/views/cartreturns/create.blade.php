...
<div x-data="form">
    <ul class="flex space-x-2 rtl:space-x-reverse">
        <li>
            <a href="{{route('my_product_order')}}" class="text-primary hover:underline">Return Cart Order</a>
        </li>
...
<div x-data="form">
   <div class="panel">
      <div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns">
        ...
        <form action="" method="post" id="checkout_form">
                  ...
                  <tr data-id="">
                     ...
                     <td>
                        <a href="" target="_blank"><img src="" class="img-responsive" alt="" style="width: 100px;" /></a>
                     </td>
                     <td>
                     ...
                     <td>
                        <div class="qty-container">
                           <button class="qty-btn-minus btn-light" onclick="PlusMinus('minus', '1')" type="button"><i class="fa fa-minus"></i></button>
                           <input type="text" name="prod_id_qty" value="1" id="prod_id_qty" class="input-qty qty-btn-minus update-cart"/>
                           <button class="qty-btn-plus btn-light" onclick="PlusMinus('plus', '2')" type="button"><i class="fa fa-plus"></i></button>
                        </div>
                     </td>
           
                     <td>
              <input type="hidden" value="40" id="prod_id_master_packing_val">
                        <div class="item-price unit-price-text" id="_master_packing_text" ></div>
                     </td>
           
           <td>
              <input type="hidden" value="" id="prod_id_price_val">
                        <div class="item-price unit-price-text" id="prod_id_price_text">₹ 50</div>
                     </td>
                     <td>
               <input type="hidden" class="single_product_subtotal" id="prod_subtotal_price_val" value="6">
              
                        <div class="item-price subtotal-price-text" id="prod_id_subtotal_price_text">₹ 50</div>
                     </td>
                  </tr>
      ...
      <div>
            ...
            <thead>
               ...
               <tr>
                  <th>Subtotal</th>
                   ...
                   <th class="subtotal-price-text" id="all_product_sub_price_text">₹ 100</th>
         ...
         <a onclick="#" href="#"><button type="button" class="btn btn-outline-primary rounded-full" style="margin-left:850px;margin-top: -43px;">Return Now</button></a>
      </div>
   </div>
</div>
