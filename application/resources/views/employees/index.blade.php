                ...
                <div class="mb-5" id="mystatusDIV" style="display: none;">
                    ...
                    <div class="mb-5 grid grid-cols-1 gap-4 sm:grid-cols-5">
                        ...
                        <div style="margin-top:35px;">
                            <a href="{{route('employees.index',['today_applied_on'=>date('Y-m-d')])}}" class="btn btn-outline-secondary" style="padding-right:40px;padding-left:40px;">Today</a>
                        </div>
                        ...
                        <div style="margin-top: 36px;">
                            <div class="search-date-group ms-5 d-flex align-items-center">
                                <select class="form-input" name="designation" id="designation">
                                    ...
                                    <option value="{{ $employee->designation }}" @if(Request::input('designation')==$employee->designation) selected @endif >{{ $employee->designation }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
