        ...
        <div class="row align-items-start mt-5 mb-5">
            <div class="col-4 col-lg-2 col-md-3">
                <div id="mobile-filter">
					...
					<div>
                        <h6 class="p-1 ">Total Products({{$myProductCount}})</h6>
                           ...
                           <div class="card mb-3">
                               <img  class= "img-responsive" src="{{asset('public/uploads/product/product_photo/'.$product->product_photo)}}" alt="" style="width: 100%;height: 300px;">
                                <div class="card-body">
									...
									<p class="card-text"><b>Warranty :</b> {{ $product->warranty_period }} Month /{{ $product->product_guarantee_type }}/{{ $product->only_spare_parts }}/{{ $product->product_warranty_type }} </p>
								    @else
